...
contract Web3RSVP {
    ...
    function createNewEvent(
        ...
        require(idToEvent[eventId].eventTimestamp == 0, "ALEADY REGISTERED");

        address[] memory confirmedRSVPs;
        address[] memory claimedRSVPs;

        // this creates a new CreateEvent struct and adds it it the idToEvent mapping
    ...
    function withdrawUnclaimedDeposits(bytes32 eventId) external {
        ...
        // check that the paidOut boolean still equals fals AKA the money hasn't
        ...
        require(msg.sender == myEvent.eventOwner, "MUST BE EVENT OWENER");
